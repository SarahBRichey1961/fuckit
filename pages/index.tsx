...
step 6) then the users must enter a phone number and when the app is built, that same phone number is on the purchase screen for the uses to zelle or venmo money to them, Capture the contact details, encrypt so only the seller can see them  for follow-up and or.
</p>
          ...
          <section className="mb-16">
            ...
            <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-slate-800 border border-slate-700 rounded-lg p-6">
                  ...
                  <p className="text-slate-400">Task 1: Set up a basic HTML/CSS layout for the app.</p>
                </div>
                <div className="bg-slate-800 border border-slate-700 rounded-lg p-6">
                  <div className="text-4xl mb-3">⚡</div>
                  <p className="text-slate-400">Task 2: Implement the front-end logic for the idea generation process.</p>
                </div>
            </div>
          </section>
        </section>
